# making the baby dragon program interactive so the user can enter the commands
...
while true
  puts ""
  puts "Please choose a command from: feed, toss, walk, put to bed, rock or exit."
  command = gets.chomp
  ...
  if command == "exit"
    ...
    puts "What? Please choose one of the commands!"
  end
